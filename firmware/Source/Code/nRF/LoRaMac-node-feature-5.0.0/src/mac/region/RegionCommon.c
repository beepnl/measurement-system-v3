...
//    calcBackOffParams->Bands[bandIdx].TimeOff = 0; // Disabled for Data break point
    ...
    if( calcBackOffParams->Joined == false )
    {
        ...
        else
        {
			...
			if(bandIdx == 1)
			{
				NRF_LOG_INFO("dutyCycle: %u, AirTime: %u, TimeOff: %u", dutyCycle, calcBackOffParams->TxTimeOnAir, calcBackOffParams->Bands[bandIdx].TimeOff);
			}
        }
    }
    else
