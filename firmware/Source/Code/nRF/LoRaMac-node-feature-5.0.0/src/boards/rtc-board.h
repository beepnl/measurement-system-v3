...
/*!
 * \brief Calculate the absolute positive difference between two values to prevent roll-over from interfering
 *
 * \param[IN] now		current counter/timestamp value
 * \param[IN] previous	Previous point in time counter/timestamp value
 * \retval returns the absolute positive difference between two timestamps.
 */
