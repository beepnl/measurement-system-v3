...
{
    uint32_t Timestamp;					 //! Timer timestamp for when the timer is started 
    uint32_t delay_ms;					 //! Timer delay value
...
void TimerStartFromTimestamp( TimerEvent_t *obj, uint32_t timestamp );
