...
#if 0 // Test code for the read and write functions to determine whether they work as intended.
    SX1276SetOpMode( RF_OPMODE_STANDBY );
    nrf_delay_ms(10);
    NRF_LOG_INFO("RFM Readback 0x01: %02X", SX1276Read(0x01));
    NRF_LOG_INFO("RFM Readback 0x39: %02X", SX1276Read(0x39));
